<x-app-layout>
    ...
    <table class="table">
        <thead class="table-primary">
            <th class="text-center fs-5">NÓMINA</th>
            <th class="text-center fs-5">NOMBRE</th>
            <th class="text-center fs-5">EDAD</th>
            <th class="text-center fs-5">FECHA DE NACIMIENTO</th>
            <th class="text-center fs-5">FECHA DE INGRESO</th>
            <th class="text-center fs-5">ÁREA</th>
            <th class="text-center fs-5">CATEGORÍA</th>
